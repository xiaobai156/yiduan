...
DEFAULT_SITES = unique_sites([
    ...
    Site("力钧势敌", "https://zpyaxwke.rp89b-fwko2-buexgv.xyz:16677/topic/245368.html", "bottom"),
    ...
    Site("澳门招财猫", "https://cthvktrb.am9a6-vk0h6-lwbxab.xyz:16677/topic/324761.html", "bottom"),
    ...
    Site("翩翩少年", "https://oofsukyp.7u9l0-zq8hd-obpxwe.work:29455/article/admin/6a02d82c8bad0a3579e9f76f?url=home", "bottom"),
    ...
    Site("暗香疏影", "https://hl.90216a.com/read.php?tid=603", "bottom"),
